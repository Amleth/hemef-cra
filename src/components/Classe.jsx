...
function C({ history, match }) {
  ...
  return Object.entries(classe).length === 0 ? (
    ...
    <Container>
      ...
      <br />
      <div style={{ textAlign: 'center' }}>⬢ : agrégation d'informations différentes constatées sur les sources</div>
      <div style={{ textAlign: 'center' }}>⬡ : valeurs identiques dans les registres et les tableaux des classes</div>
      <br />
      <br />
      <MaterialTable
        components={{

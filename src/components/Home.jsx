      ...
      <Grid container className={classes.gridContainer} spacing={10}>
        <Grid item xs={7}>
          <Typography variant='body1' color='textSecondary' align='justify'>
            Cette base de données recense les élèves, musiciens ou comédiens, inscrits au Conservatoire national de Paris depuis sa fondation en 1795 jusqu’en 1914. Elle permet de suivre leur cursus au sein du Conservatoire et de croiser ces données avec celles qui concernent leur état civil, origine sociale, origine géographique, cursus antérieur et postérieur à celui du Conservatoire.
          </Typography>
        </Grid>
        <Grid item xs={5}>
          <List className={classes.list}>
            ...
            <ListItem disableGutters={true}>
              ...
              <ListItemText primary='Modélisation sémantique & développement logiciel' secondary='Pierre LA ROCCA & Thomas BOTTINI' />
            </ListItem>
